...
-- insert into groups set groupName = 'Group 2', isActive = 1;
-- insert into groups set groupName = 'Group 3';
-- insert into groups set groupName = 'Group 4';

-- update groups set isActive = false where groupId = 4;
-- update groups set isActive = true where groupId = 3;
